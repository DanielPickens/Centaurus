...
import (
	"fmt"
	"github.com/danielpickens/centaurus/backend/config"
	"github.com/danielpickens/centaurus/backend/container"
	"github.com/danielpickens/centaurus/backend/routes"
...
var rootCmd = &cobra.Command{
	Use:   "centaurus",
	Short: "centaurus",
	Long:  `centaurus is a single binary web app to manage multiple clusters https://github.com/centaurus/centaurus`,
...
func startBanner() {
	fmt.Println(" _          _                        _ _ ")
	fmt.Println(" CENTAURUS
	fmt.Println("___________________________________________")
	fmt.Println("version:", Version)
	fmt.Println("commit:", Commit)
	fmt.Println("https://github.com/DANIELPICKENS/centaurus")
	fmt.Println("___________________________________________")
}
